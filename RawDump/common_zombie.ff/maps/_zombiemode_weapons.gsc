...
//	PrecacheItem( "zombie_melee" );
	...
	add_zombie_weapon( "shrink_ray_zm", 			"shrink_ray_upgraded_zm", 				&"ZOMBIE_TEMPLE_SHRINK_RAY", 			2000, 	"shink_ray", 		"", 	undefined );
	add_zombie_weapon( "blow_gun_zm", 				"blow_gun_upgraded_zm", 				&"ZOMBIE_TEMPLE_BLOW_GUN", 				2000, 	"darts", 		"", 	undefined );
...
//Z2 HasPerk is returning undefined for "specialty_threeprimaries" 
// 	if ( self HasPerk( "specialty_threeprimaries" ) )
// 	{
// 		weapon_limit = 3;
// 	}
...
weapon_spawn_think()
{
	...
	for( ;; )
	{
		...
		if( player GetCurrentWeapon() == "minigun_zm" ) // WW: is the player has the minigun power up
		{
			wait( 0.1 );
			continue;
		}
